---
tags: [Bash,TODO]
last_modified_time: 2019-10-26 12:22:35 +0800
---
...
* [using trap ctrl+c](#using-trap-ctrlc)
* [实践记录](#实践记录)
  * [处理缩略语](#处理缩略语)
    * [使用`grep`](#使用grep)
    * [使用`case..in..`](#使用casein)
...
function bash_completion()
{
	...
	if [ $bmajor -gt 4 ] || [ $bmajor -eq 4 -a $bminor -ge 1 ]; then
        ...
        bash_completion_dir=$([[ -r /usr/share/bash-completion/bash_completion ]] && \
            echo /usr/share/bash-completion/bash_completion || \
            echo /usr/local/share/bash-completion/bash_completion)
        if shopt -q progcomp && [ -r $bash_completion_dir ]; then
