---
tags: [Vim]
last_modified_time: 2019-07-11 19:55:54 +0800
---
...
1. 将博客格式转换 bbs 格式（例如 2019-07-07-科学上网.md）：
   ```
   qo
:%s/&emsp;&emsp;//5GdggO这是我博客上的文章，自我感觉写得还可以，于是搬到这里来了。原文地址：[科学上网](https://wsxq2.55555.io/blog/2019/07/07/%E7%A7%91%E5%AD%A6%E4%B8%8A%E7%BD%91/):g/^<p id=/d:g/^<!-- .* -->/d:g/^\*\[.*\]: /d
   ```
