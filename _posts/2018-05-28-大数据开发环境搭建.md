...
## 2 安装TensorFlow和Jupyter notebook
...
Jupyter官方网站：<http://Jupyter.org/index.html>
...
### 2.2 安装TensorFlow
TensorFlow官方网站：<https://www.TensorFlow.org/?hl=zh-cn>
...
### 3.2 安装Hadoop及配置伪集群
参考链接：[Hadoop: Setting up a Single Node Cluster.](http://hadoop.apache.org/docs/r2.8.4/hadoop-project-dist/hadoop-common/SingleCluster.html)
...
官方文档：[QUICKSTART](https://kafka.apache.org/quickstart)
