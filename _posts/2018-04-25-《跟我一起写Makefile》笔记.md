...
* [使用函数](#使用函数)
  * [函数的调用语法](#函数的调用语法)
  * [函数参考 {#reference-hsck}](#函数参考-reference-hsck)
* [make 的运行 {#jump1}](#make-的运行-jump1)
  * [make的退出码](#make的退出码)
  * [指定makefile](#指定makefile)
  * [指定目标](#指定目标)
  * [检查规则](#检查规则)
  * [make的参数 {#reference-mdcs}](#make的参数-reference-mdcs)
* [隐含规则 {#jump3}](#隐含规则-jump3)
  * [使用隐含规则](#使用隐含规则)
  * [隐含规则 {#reference-yhgz}](#隐含规则-reference-yhgz)
  * [隐含规则使用的变量 {#reference-yhgzsydbl}](#隐含规则使用的变量-reference-yhgzsydbl)
  * [定义模式规则 {#jump4}](#定义模式规则-jump4)
    * [自动化变量 {#reference-zdhbl}](#自动化变量-reference-zdhbl)
    * [模式的匹配 {#jump5}](#模式的匹配-jump5)
    * [重载内建隐含规则](#重载内建隐含规则)
...
* [使用make更新函数库文件](#使用make更新函数库文件)
  ...
  * [伪目标 {#reference-wmb}](#伪目标-reference-wmb)
