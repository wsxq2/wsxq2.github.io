...
* man sed
* info sed
* [sed.sf.net - The sed $HOME](http://sed.sourceforge.net/)
* [sed.sourceforge.net/grabbag/scripts/remccoms3.sed](http://sed.sourceforge.net/grabbag/scripts/remccoms3.sed)
## sed 命令行参数
使用`sed --help`可得到如下帮助：
<pre>
