...
- CPU：[CPU-Z](https://www2.cpuid.com/softwares/cpu-z.html)
- GPU：[GPU-Z](https://www.techpowerup.com/gpuz/)
- 固态硬盘：
  - [使用 smartmontools 查看你的 SSD 健康状态（macOS、Linux、Windows） - sysin \| SYStem INside \| 软件与技术分享](https://sysin.org/blog/smartmontools/#Windows-10)
  - [CrystalDiskInfo](https://crystalmark.info/en/software/crystaldiskinfo/)
  - [CrystalDiskMark](https://crystalmark.info/en/software/crystaldiskmark/)
  - disk genius
- CPU温度读取和统计：[CoreTemp](https://www.alcpu.com/CoreTemp/)。我的笔记本电脑使用的 CPU 是 AMD R7 4800H，它的最高温度居然可达 105 度，属实有点震惊了，详见 [AMD Ryzen™ 7 4800H Drivers](https://www.amd.com/en/support/downloads/drivers.html/processors/ryzen/ryzen-4000-series/amd-ryzen-7-4800h.html#amd_support_product_spec)
