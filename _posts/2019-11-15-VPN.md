...
通过 [PPTP Client](http://pptpclient.sourceforge.net/howto-diagnosis.phtml#lcp_timeout) 排查后得出问题出在 [No GRE received by PPTP Client](http://pptpclient.sourceforge.net/howto-diagnosis.phtml#client_no_gre_rx) 的 [Simultaneous Tunnels via NAT Gateway](https://pptpclient.sourceforge.net/howto-diagnosis.phtml#gre) 处：
